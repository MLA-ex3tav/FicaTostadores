    ...
    <div className="mx-auto max-w-6xl px-4 py-10 md:px-6">
      ...
      {!canPersist && (
        <p className="mt-6 rounded-lg border border-orange/30 bg-orange/10 px-4 py-3 text-sm text-orange">
          En producción debe configurar{" "}
          <code className="text-steel-light">BLOB_READ_WRITE_TOKEN</code> en
          Vercel para guardar cambios. Sin eso solo puede ver el catálogo.
        </p>
      )}
