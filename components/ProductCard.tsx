...
export default function ProductCard({ product, catalogConfig }: ProductCardProps) {
  ...
  return (
    ...
    >
      <article
        className={cn(
          "relative flex h-full min-w-0 w-full flex-col overflow-hidden rounded-xl border border-transparent bg-panel p-6 transition-all duration-300 md:p-8",
          "group-hover:-translate-y-1 group-hover:border-orange group-hover:shadow-xl group-hover:shadow-black/40",
      ...
      >
        ...
        <div className="flex flex-1 flex-col">
          <div className="mb-4">
            ...
            <p className="mt-0.5 text-sm uppercase tabular-nums tracking-widest text-orange">
              {product.capacity}
            </p>
          </div>
