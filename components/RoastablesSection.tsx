      ...
      >
        {roastables.map((item) => (
          <StaggerItem
            as="li"
            key={item.name}
            className="flex items-center gap-2.5 rounded-lg border border-steel-dark/20 bg-panel/60 px-3.5 py-2 text-steel-mid transition-colors hover:border-orange/60 hover:text-steel-light"
          >
            <item.Icon
