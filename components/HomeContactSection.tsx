  ...
  return (
    <section className="border-b border-steel-dark/15 py-10 md:py-14">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        ...
        <Link
          href="/contacto"
          className="mt-8 inline-flex items-center gap-2 rounded-lg border border-orange/50 bg-orange/10 px-5 py-3 text-base font-medium text-orange transition-all hover:bg-orange hover:text-white hover:shadow-lg hover:shadow-orange/25"
        >
